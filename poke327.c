...
void game_loop()
{
    ...
    if (has_colors() == TRUE) {
        start_color();
        init_pair(1, COLOR_WHITE, COLOR_BLACK);    // Grey for boulders
        init_pair(2, COLOR_WHITE, COLOR_BLACK);  // Grey for mountains
        init_pair(3, COLOR_GREEN, COLOR_BLACK);   // Green for trees
        init_pair(4, COLOR_CYAN, COLOR_BLACK); // Cyan for forest
        init_pair(5, COLOR_YELLOW, COLOR_BLACK); // Yellow for path
        init_pair(6, COLOR_YELLOW, COLOR_BLACK); // Yellow for gate
        init_pair(7, COLOR_RED, COLOR_BLACK); // Red for Mart
        init_pair(8, COLOR_MAGENTA, COLOR_BLACK); // Magenta for center
        init_pair(9, COLOR_GREEN, COLOR_BLACK); // Green for grass
        init_pair(10, COLOR_WHITE, COLOR_BLACK); // White for clearing
        init_pair(11, COLOR_BLUE, COLOR_BLACK); // Blue for water
        
    }

    int ch; // Variable to store the key pressed
    ...
    while (1) {
        ...
        if (c == &world.pc) {
            ...
            switch (ch) {
                case '7':
                case 'y':
                    // Move PC one cell to the upper left
                    break;
                case '8':
                case 'k':
                    // Move PC one cell up
                ...
                case '9':
                case 'u':
                    // Move PC one cell to the upper right
                    break;
                case '6':
                case 'l':
                    // Move PC one cell to the right
                    break;
                case '3':
                case 'n':
                    // Move PC one cell to the lower right
                    break;
                case '2':
                case 'j':
                ...
                case '1':
                case 'b':
                    // Move PC one cell to the lower left
                    break;
                case '4':
                case 'h':
                    ...
                    break;
                case '>':
                    // Enter a Pokemart or Pokemon Center (placeholder for now)
                    break;
                case '5':
                case ' ':
                case '.':
                ...
                case 't':
                    ...
                    break;
                case KEY_UP:
                    // Scroll trainer list up
                    break;
                case KEY_DOWN:
                    // Scroll trainer list down
                    break;
                case 27: // Escape key
                    // Return to character control from trainer list
                    break;
                case 'Q':
                    endwin(); // Cleanup ncurses
                    return; // Exit the game loop
                default:
                    // No-op for undefined keys
                    break;
            }
...
void triggerPokemonBattle() {
    // Placeholder code
    int ch;
    while(1) {
        ch = getch();
        if(ch == 27) { // Escape key
            // Mark NPC as defeated and exit loop
            break;
        }
    }
}
